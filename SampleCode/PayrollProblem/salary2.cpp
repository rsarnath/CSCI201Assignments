// A payroll program. This is where we do the second step and compute 
// the total salary for the week; all the other  tests fail. 
...
{/* Read hourly wage from infile and compute salary */
